...
//
//http://www.codeproject.com/KB/dotnet/twaindotnet.aspx?fid=2619&df=90&mpp=25&noise=3&sort=Position&view=Quick&select=2537485&fr=126
//
namespace TigEra.DocScaner.Adapter.PBTwain
{
    internal class twainDefs
    {
        ...
        internal enum TwCap : short
        {
            ...
            IUnits = 0x0102,
            IXferMech = 0x0103,
            CAP_ENABLEDSUIONLY = 0x1014   /* Added 1.7 */
        }
        ...
        {
            public short Whole;        /* maintains the sign */
            public ushort Frac;
        }
        ...
        internal class TwImageLayout
        {
            ...
            public ulong PageNumber;     /* Reset when you go to next document  */
            public ulong FrameNumber;    /* Reset when you go to next page      */
        }
